...
&& sudo java -jar jenkins-plugin-manager-2.11.0.jar --war /usr/lib/jenkins/jenkins.war --plugin-download-directory /var/lib/jenkins/plugins --plugins --plugins nodejs \
&& sudo java -jar jenkins-plugin-manager-2.11.0.jar --war /usr/lib/jenkins/jenkins.war --plugin-download-directory /var/lib/jenkins/plugins --plugins --plugins mongodb \
